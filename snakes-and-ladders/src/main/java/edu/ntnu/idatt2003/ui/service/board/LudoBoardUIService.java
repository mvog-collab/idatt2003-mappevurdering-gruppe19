    ...
    public void addOverlays(Pane overlayPane, List<OverlayParams> overlays) {
        ...
        for (OverlayParams params : overlays) {
            ...
            ImageView iv = new ImageView(
                new Image(getClass().getResourceAsStream(params.getImagePath())));
