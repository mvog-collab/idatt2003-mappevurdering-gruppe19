...
/**
 * LudoPath – builds a colored graph of 52 + 4×6 squares Handles the movement
 * logic for a Ludo game
...
public final class LudoPath implements MovementPath {
  ...
  /**
   * Get the starting tile for a specific color Called when a player rolls a 6 and
   * can leave home
   */
